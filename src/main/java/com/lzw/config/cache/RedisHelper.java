...
public final class RedisHelper implements CacheManager, ApplicationContextAware {
    ...
    private Integer EXPIRE = 2000000;
    ...
    // 获取连接  这里为什么用双重检查锁，因为 RedisHelper 被静态管理了，是单例的，启动时初始化，并且加载类，加载类时 redisTemplate赋值为null。
    // 真正使用 getRedis()时，是懒加载模式，懒加载模式避免 多线程重复创建对象，这里就使用了 双重检查锁。
    ...
    public Object deserialize(String str) {
        ...
        try {
            bis = new ByteArrayInputStream(Base64.base64ToByteArray(str));
